...
const MentalHealth = () => {
  return (
      ...
      <div className='container'>
        <div className={"row " + Style.section}>
          <div className="col-md-6">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/DcMy7_ZV6tw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          <div className="col-md-6">
            <h1 className='title'>Beam’s Commitment to Mental Health</h1>
    ...
    <div className='container'>
      <div className={"row " + Style.section}>
        <div className="col-md-6">
          ...
          <button className={Style.blueButton}>Try Now</button>
        </div>
        <div className="col-md-6">
    ...
    <div className={Style.backgroundImage}>
      <div className={'row ' + Style.section2}>
        <div className='col-12'>
          ...
          <button className={Style.bannerButton}>Try Live Demo</button>
        </div>
      </div>
    </div>
    ...
    <div className="row section1">
      <div className="col-md-6">
        <img className='image1' src="https://beam.health/wp-content/uploads/2021/11/scalable-image-1.png"></img>
      </div>
      <div className="col-md-6">
        ...
        <button className={Style.blueButton}>Learn More</button>
      </div>
    </div>
